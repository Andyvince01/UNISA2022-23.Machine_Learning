...
class FireNetAGM(nn.Module):
    def __init__(self, num_classes=1, gru_hidden_size = 64, gru_num_layers = 2, dropout_prob=0.75):
        ...
        # GRU for sequence handling
        self.gru = nn.GRU(1280, gru_hidden_size, gru_num_layers, batch_first = True)
